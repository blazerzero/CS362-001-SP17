// URL: http://examples.oreilly.com/9781565923713/ShowClass.java
...
public class ShowClass {
  ...
  public static void print_class(Class c)
  {
    ...
    if (c.isInterface()) {
      ...
      System.out.print(Modifier.toString(c.getModifiers()));	// ****ADDED BUG**** removed '+ " "+c.getName()'
    }
    else if (c.getSuperclass() != null)
      System.out.print(Modifier.toString(c.getModifiers()) + " class " +	// ****ADDED BUG**** switched placement of c.getName() and c.getSuperclass()
  ...
  public static void print_method_or_constructor(Member member) {
    ...
    if (!(member instanceof Method)) {		// ****ADDED BUG**** negated if statement condition
